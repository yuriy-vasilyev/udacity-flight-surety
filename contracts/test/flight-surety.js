const FlightSurety = artifacts.require("FlightSuretyData");

contract("FlightSuretyData", (accounts) => {
  it("should put 10000 FlightSuretyData.sol in the first account", async () => {
    const metaCoinInstance = await FlightSurety.deployed();
